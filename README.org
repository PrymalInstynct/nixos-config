...
#+begin_src
  ...
  # git clone https://github.com/PrymalInstynct/nixos-config /mnt/etc/nixos/<name>
...
1. If you are planning on using the doom-emacs alternative home.nix, don't forget to rebuild after the initial installation when you link to this nix file.
...
2. Set up Git global configurations
   - ~$ git config --global user.email <email>~
   - ~$ git config --global user.name <name>~
3. Copy ssh keys to host
